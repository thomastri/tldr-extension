...
public class DefaultSummarizer implements Summarizer {
    public DefaultSummarizer(){}//default constructor
    ...
    public String getSummary(String text, int numSentences)
    {
        ...
        {
            if(setSummarySentences.contains(sentence) && numSentences > 0)
            {
